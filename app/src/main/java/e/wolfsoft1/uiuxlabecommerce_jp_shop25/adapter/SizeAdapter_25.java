...
public class SizeAdapter_25 extends RecyclerView.Adapter<SizeAdapter_25.MySizeHolder> {

    private final ArrayList<Size_Model> size_modelArrayList;
    private final Context context;
    private int position;

    public SizeAdapter_25(Context context, ArrayList<Size_Model> size_modelArrayList) {
    ...
    public MySizeHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_size_25, viewGroup, false);
