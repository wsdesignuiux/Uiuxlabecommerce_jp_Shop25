...
public class ColorAdapter_25 extends RecyclerView.Adapter<ColorAdapter_25.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model> color_modelArrayList;
    private int position;

    public ColorAdapter_25(Context context, ArrayList<Color_Model> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_25    , viewGroup, false);
